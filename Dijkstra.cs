...
namespace PathAlgorithms
{
    ...
    class Dijkstra
    {
        ...
        public Dijkstra(int start_x, int start_y, int end_x, int end_y, int height_, int width_, List<int> wallx, List<int> wally)
        {
            startX = start_x;
            startY = start_y;
            endX = end_x;
        ...
        Dictionary<Tuple<int, int>, int> Weights = new Dictionary<Tuple<int, int>, int>();
        ...
        public Tuple<List<Tuple<int, int>>, List<Tuple<int, int>>> get_Dijkstra_path()
        {
